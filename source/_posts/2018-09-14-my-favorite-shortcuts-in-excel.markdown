---
layout: post
title: "My favorite shortcuts in Excel"
date: 2018-09-14 08:45:43 +0200
comments: true
categories: 
- Excel
- Shortcuts
...
I love shortcuts. They are the most important tool in my productivity tool belt. Helping me to speed things up immensely. Here are the most important shortcuts that I us in Excel all the time: 
...
{%img /images/Excel_Current_Date.gif 'Current Date Shortcut' 'Animated git showing how to insert the current date in a cell' %}

To insert the current time in Excel, press Ctrl+Shift+; (semi-colon) at the same time on Windows or +; (semi-colon) on Mac.

{%img /images/Excel_Current_Time.gif 'Current Time Shortcut' 'Animated git showing how to insert the current time in a cell' %}
...
{%img /images/Excel_Content_From_Above.gif 'Copy the content from the top' 'Animated git showing how to insert the content of the top cell in our current cell' %}

To copy cell content from the left of your current cell in Excel hit Ctrl+R on Both Windows and Mac. 

{%img /images/Excel_Content_From_Left.gif 'Copy the content from the left' 'Animated git showing how to insert the content of the left cell in our current cell' %}
